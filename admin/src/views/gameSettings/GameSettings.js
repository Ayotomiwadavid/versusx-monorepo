...
import { CCard, CCardBody, CCol, CCardHeader, CRow, CButton, CFormLabel, CFormInput } from '@coreui/react'
          ...
          <CRow>
            ...
            <CCol xs={1}>
              <CFormInput
                ...
                value={timer0}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setTimer0(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={3}>
          ...
          <CRow>
            ...
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={ballCount[0]}
                value={ballCount0}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setBallCount0(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={ballCount[1]}
                value={ballCount1}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setBallCount1(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={ballCount[2]}
                value={ballCount2}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setBallCount2(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={ballCount[3]}
                value={ballCount3}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setBallCount3(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={3}>
          ...
          <CRow>
            ...
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={winPercentage[0]}
                value={winPercent0}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setWinPercent0(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={winPercentage[1]}
                value={winPercent1}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setWinPercent1(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={winPercentage[2]}
                value={winPercent2}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setWinPercent2(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={1}>
              <CFormInput
                ...
                size="sm"
                id="winpercent0"
                placeholder={winPercentage[3]}
                value={winPercent3}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 1000) setWinPercent3(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={3}>
          ...
          <CRow className="mb-2">
            ...
            <CCol xs={2}>
              <CFormInput
                ...
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 100) setPrizePercentage(event.target.value)
                }}
              />
            </CCol>
          </CRow>
          <CRow>
            ...
            <CCol xs={2}>
              <CFormInput
                ...
                value={prizeAddress}
                onChange={(event) => {
                  setPrizeAddress(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={3}>
          ...
          <CRow>
            ...
            <CCol xs={2}>
              <CFormInput
                ...
                value={feeNFTBetting}
                onChange={(event) => {
                  setFeeNFTBetting(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={3}>
