...
import { CCard, CCardBody, CCol, CCardHeader, CRow, CButton, CFormLabel, CFormInput, CFormTextarea, CFormSelect } from '@coreui/react'
...
const ESGToken = () => {
  ...
  const [, setTaxOption] = useState('1')
  const [shareExemptAddress, setShareExemptAddress] = useState('')
  const [, setShareExemptValue] = useState(true)
          ...
          <CRow>
            <CCol xs={2}>
              <CFormInput
                ...
                size="sm"
                id="fee"
                placeholder="8 or 7.55"
                value={taxFee}
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 25) setTaxFee(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={6}>
          ...
          <CRow>
            <CCol xs={6}>
              <CFormTextarea
                ...
                onChange={(event) => {
                  setTaxFeeReceiver(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={6}>
        ...
        <CCardBody>
          <CRow>
            ...
            <CCol xs={6}>
              <CFormTextarea
                size="sm"
                id="shareExemptAddress"
                rows="1"
                placeholder="0x1234..."
                value={shareExemptAddress}
                onChange={(event) => {
                  setShareExemptAddress(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={2}>
              <CFormSelect
                ...
                aria-label="Small select example"
                onChange={(event) => {
                  event.target.value === '1' ? setShareExemptValue(true) : setShareExemptValue(false)
                }}
              >
