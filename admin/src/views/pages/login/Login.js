              ...
              <CCardBody>
                <CForm action={process.env.REACT_APP_BASE_URL + '/login'} method="post">
                  ...
                  <CInputGroup className="mb-3">
                    ...
                    <CFormInput type="password" placeholder="Password" autoComplete="current-password" required="required" name="password" />
                  </CInputGroup>
                  <CInputGroup className="mb-4">
                    <CInputGroupText>
                      <CIcon icon={cilEnvelopeClosed} />
                    </CInputGroupText>
                    <CFormInput type="text" placeholder="Email" required="required" name="email" />
                  </CInputGroup>
                  <CRow>
                    <CCol xs={12}>
