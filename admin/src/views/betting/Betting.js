...
import { CCard, CCardBody, CCol, CCardHeader, CRow, CButton, CFormLabel, CFormInput, CFormTextarea, CContainer } from '@coreui/react'
          ...
          <CRow>
            ...
            <CCol xs={2}>
              <CFormInput
                ...
                onChange={(event) => {
                  if (Number(event.target.value) >= 0 && Number(event.target.value) <= 25) setWithdrawAmount(event.target.value)
                }}
              />
            </CCol>
            <CCol xs={4}>
