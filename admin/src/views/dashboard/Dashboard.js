...
const Dashboard = () => {
  ...
  const [, setEarnESGData] = useState({})
  const [, setEarnESGMATICData] = useState({})
  const [, setEarnESGUSDTData] = useState({})
  ...
  const [, setTotalEsgSel] = useState()
  const [, setTotalEsgUsdSel] = useState()
  //////
  ...
  const [, setTotalEsgEarn] = useState()
  const [totalSportUsdEarn, setTotalSportUsdEarn] = useState()
  const [, setTotalEsgUsdEarn] = useState()
          ...
          <CRow>
            ...
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (userActive[0] === true ? 'active' : '')} onClick={() => onUserCounts('week', 0, 'ESG')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (userActive[1] === true ? 'active' : '')} onClick={() => onUserCounts('month', 1, 'ESG')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (userActive[2] === true ? 'active' : '')} onClick={() => onUserCounts('3month', 2, 'ESG')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (userActive[3] === true ? 'active' : '')} onClick={() => onUserCounts('year', 3, 'ESG')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
      ...
      <CCard className="mb-4">
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {spGameData.from} ~ {spGameData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (spGameActive[0] === true ? 'active' : '')} onClick={() => onSPGameData('week', 0)}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (spGameActive[1] === true ? 'active' : '')} onClick={() => onSPGameData('month', 1)}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (spGameActive[2] === true ? 'active' : '')} onClick={() => onSPGameData('3month', 2)}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (spGameActive[3] === true ? 'active' : '')} onClick={() => onSPGameData('year', 3)}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Selected SPGame Played: &nbsp;
                <strong>{spGameData.selCount}</strong>
              </div>
            </CCol>
          </CRow>
        </CCardFooter>
      ...
      <CCard className="mb-4">
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {mpGameData.from} ~ {mpGameData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mpGameActive[0] === true ? 'active' : '')} onClick={() => onMPGameData('week', 0)}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mpGameActive[1] === true ? 'active' : '')} onClick={() => onMPGameData('month', 1)}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mpGameActive[2] === true ? 'active' : '')} onClick={() => onMPGameData('3month', 2)}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mpGameActive[3] === true ? 'active' : '')} onClick={() => onMPGameData('year', 3)}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Selected MPGame Played: &nbsp;
                <strong>{mpGameData.selCount}</strong>
              </div>
            </CCol>
          </CRow>
        </CCardFooter>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {wagerSPGameData.from} ~ {wagerSPGameData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (wagerSPGameActive[0] === true ? 'active' : '')} onClick={() => onWagerSPGameData('week', 0)}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (wagerSPGameActive[1] === true ? 'active' : '')} onClick={() => onWagerSPGameData('month', 1)}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (wagerSPGameActive[2] === true ? 'active' : '')} onClick={() => onWagerSPGameData('3month', 2)}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (wagerSPGameActive[3] === true ? 'active' : '')} onClick={() => onWagerSPGameData('year', 3)}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Selected Wager: &nbsp;
                <strong>{wagerSPGameData.selWager}</strong>
              </div>
            </CCol>
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Average Wager: &nbsp;
                <strong>{Number(wagerSPGameData.selWager / wagerSPGameData.selCount).toFixed(1)}</strong>
              </div>
            </CCol>
          </CRow>
        </CCardFooter>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {wagerMPGameData.from} ~ {wagerMPGameData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (wagerMPGameActive[0] === true ? 'active' : '')} onClick={() => onWagerMPGameData('week', 0)}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (wagerMPGameActive[1] === true ? 'active' : '')} onClick={() => onWagerMPGameData('month', 1)}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (wagerMPGameActive[2] === true ? 'active' : '')} onClick={() => onWagerMPGameData('3month', 2)}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (wagerMPGameActive[3] === true ? 'active' : '')} onClick={() => onWagerMPGameData('year', 3)}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Selected Wager: &nbsp;
                <strong>{wagerMPGameData.selWager}</strong>
              </div>
            </CCol>
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Average Wager: &nbsp;
                <strong>{Number(wagerMPGameData.selWager / wagerMPGameData.selCount).toFixed(1)}</strong>
              </div>
            </CCol>
          </CRow>
        </CCardFooter>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {mintData.from} ~ {mintData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintActive[0] === true ? 'active' : '')} onClick={() => onNFTMintDate('week', 0, 'CUE')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintActive[1] === true ? 'active' : '')} onClick={() => onNFTMintDate('month', 1, 'CUE')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintActive[2] === true ? 'active' : '')} onClick={() => onNFTMintDate('3month', 2, 'CUE')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintActive[3] === true ? 'active' : '')} onClick={() => onNFTMintDate('year', 3, 'CUE')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {mintCardData.from} ~ {mintCardData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintCardActive[0] === true ? 'active' : '')} onClick={() => onNFTMintDate('week', 0, 'CARD')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintCardActive[1] === true ? 'active' : '')} onClick={() => onNFTMintDate('month', 1, 'CARD')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintCardActive[2] === true ? 'active' : '')} onClick={() => onNFTMintDate('3month', 2, 'CARD')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintCardActive[3] === true ? 'active' : '')} onClick={() => onNFTMintDate('year', 3, 'CARD')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 4 }} className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Selected Count : &nbsp;
                <strong>{totalSelMintCard}</strong>
              </div>
      ...
      <CCard className="mb-4">
        <CCardBody>
          <CRow>
            <CCol sm={8}>
              ...
              <div className="small text-medium-emphasis">
                {earnMarketFeeData.from} ~ {earnMarketFeeData.to}
              </div>
            </CCol>
            <CCol sm={4} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintEarnFeeActive[0] === true ? 'active' : '')} onClick={() => onMintEarnDate('week', 0, 'CUE', 'FEE')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintEarnFeeActive[1] === true ? 'active' : '')} onClick={() => onMintEarnDate('month', 1, 'CUE', 'FEE')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnFeeActive[2] === true ? 'active' : '')} onClick={() => onMintEarnDate('3month', 2, 'CUE', 'FEE')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnFeeActive[3] === true ? 'active' : '')} onClick={() => onMintEarnDate('year', 3, 'CUE', 'FEE')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Earned Amounts During Selected Time Period: &nbsp;
                <strong>{totalEarnMintCueFee[1]}</strong>
                &nbsp;MATIC
              </div>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={8}>
              ...
              <div className="small text-medium-emphasis">
                {earnMarketData.from} ~ {earnMarketData.to}
              </div>
            </CCol>
            <CCol sm={4} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintEarnActive[0] === true ? 'active' : '')} onClick={() => onMintEarnDate('week', 0, 'CUE', 'EARN')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintEarnActive[1] === true ? 'active' : '')} onClick={() => onMintEarnDate('month', 1, 'CUE', 'EARN')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnActive[2] === true ? 'active' : '')} onClick={() => onMintEarnDate('3month', 2, 'CUE', 'EARN')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnActive[3] === true ? 'active' : '')} onClick={() => onMintEarnDate('year', 3, 'CUE', 'EARN')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Earned Amounts During Selected Time Period: &nbsp;
                <strong>{totalEarnMintCue[1]}</strong>
                &nbsp;MATIC
              </div>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={8}>
              ...
              <div className="small text-medium-emphasis">
                {earnMarketCardFeeData.from} ~ {earnMarketCardFeeData.to}
              </div>
            </CCol>
            <CCol sm={4} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintEarnCardFeeActive[0] === true ? 'active' : '')} onClick={() => onMintEarnDate('week', 0, 'CARD', 'FEE')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardFeeActive[1] === true ? 'active' : '')} onClick={() => onMintEarnDate('month', 1, 'CARD', 'FEE')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardFeeActive[2] === true ? 'active' : '')} onClick={() => onMintEarnDate('3month', 2, 'CARD', 'FEE')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardFeeActive[3] === true ? 'active' : '')} onClick={() => onMintEarnDate('year', 3, 'CARD', 'FEE')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Earned Amounts During Selected Time Period: &nbsp;
                <strong>{totalEarnMintCardFee[1]}</strong>
                &nbsp;MATIC
              </div>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={8}>
              ...
              <div className="small text-medium-emphasis">
                {earnMarketCardData.from} ~ {earnMarketCardData.to}
              </div>
            </CCol>
            <CCol sm={4} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintEarnCardActive[0] === true ? 'active' : '')} onClick={() => onMintEarnDate('week', 0, 'CARD', 'EARN')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardActive[1] === true ? 'active' : '')} onClick={() => onMintEarnDate('month', 1, 'CARD', 'EARN')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardActive[2] === true ? 'active' : '')} onClick={() => onMintEarnDate('3month', 2, 'CARD', 'EARN')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintEarnCardActive[3] === true ? 'active' : '')} onClick={() => onMintEarnDate('year', 3, 'CARD', 'EARN')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            ...
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Earned Amounts During Selected Time Period: &nbsp;
                <strong>{totalEarnMintCard[1]}</strong>
                &nbsp;MATIC
              </div>
        ...
        <CCardBody>
          <CRow>
            <CCol sm={8}>
              ...
              <div className="small text-medium-emphasis">
                {earnDataBet.from} ~ {earnDataBet.to}
              </div>
            </CCol>
            <CCol sm={4} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (earnActive[0] === true ? 'active' : '')} onClick={() => onEarnDate('week', 0, 'BET', 'SPORT')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (earnActive[1] === true ? 'active' : '')} onClick={() => onEarnDate('month', 1, 'BET', 'SPORT')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (earnActive[2] === true ? 'active' : '')} onClick={() => onEarnDate('3month', 2, 'BET', 'SPORT')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (earnActive[3] === true ? 'active' : '')} onClick={() => onEarnDate('year', 3, 'BET', 'SPORT')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            ...
            <CCol className="mb-sm-4 mb-0">
              <div className="text-medium-emphasis">
                Earned Amounts During Selected Time Period: &nbsp;
                <strong>{totalSportSel}</strong>
                &nbsp; SPORT (<strong>{totalSportUsdSel}</strong>
                $)
              </div>
      ...
      <CCard className="mb-4">
        <CCardBody>
          <CRow>
            <CCol sm={6}>
              ...
              <div className="small text-medium-emphasis">
                {mintSportData.from} ~ {mintSportData.to}
              </div>
            </CCol>
            <CCol sm={6} style={{ textAlign: 'right' }}>
              <CButtonGroup role="group" aria-label="">
                <CButton color={'primary ' + (mintSportActive[0] === true ? 'active' : '')} onClick={() => onMintDate('week', 0, 'SPORT')}>
                  Weekly
                </CButton>
                <CButton color={'primary ' + (mintSportActive[1] === true ? 'active' : '')} onClick={() => onMintDate('month', 1, 'SPORT')}>
                  Monthly
                </CButton>
                <CButton color={'primary ' + (mintSportActive[2] === true ? 'active' : '')} onClick={() => onMintDate('3month', 2, 'SPORT')}>
                  3 Monthly
                </CButton>
                <CButton color={'primary ' + (mintSportActive[3] === true ? 'active' : '')} onClick={() => onMintDate('year', 3, 'SPORT')}>
                  Annual
                </CButton>
              </CButtonGroup>
            </CCol>
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 11 }} className="text-center">
            <CCol className="mb-sm-2 mb-0">
              <div className="text-medium-emphasis">
                Minted Amounts During Selected Time Period: &nbsp;
                <strong>{totalMintSportSel}</strong>
                &nbsp; SPORT
              </div>
            </CCol>
          </CRow>
