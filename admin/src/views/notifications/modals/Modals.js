  ...
  return (
    <>
      ...
      <CModal alignment="center" visible={visible} onClose={() => setVisible(false)}>
        ...
        <CModalBody>Cras mattis consectetur purus sit amet fermentum. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</CModalBody>
        <CModalFooter>
          <CButton color="secondary" onClick={() => setVisible(false)}>
            Close
          </CButton>
    ...
    <CRow>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">Toggle a working modal demo by clicking the button below. It will slide down and fade in from the top of the page.</p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              If you don’t provide an <code>onDimsiss</code> handler to the Modal component, your modal will behave as though the backdrop is static, meaning it will not close when clicking outside it. Click the button below to try it.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <p className="text-medium-emphasis small">
              You can also create a scrollable modal that allows scroll the modal body by adding <code>scrollable</code> prop.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              <code>&lt;CTooltips&gt;</code> and <code>&lt;CPopovers&gt;</code> can be placed within modals as needed. When modals are closed, any tooltips and popovers within are also automatically dismissed.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Modals have three optional sizes, available via modifier classes to be placed on a <code>&lt;CModal&gt;</code>. These sizes kick in at certain breakpoints to avoid horizontal scrollbars on narrower viewports.
            </p>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              Another override is the option to pop up a modal that covers the user viewport, available via property <code>fullscrean</code>.
            </p>
            <table className="table">
              <thead>
                <tr>
