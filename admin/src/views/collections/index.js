...
import { CSpinner, CFormSelect, CForm, CFormInput, CCard, CCardBody, CCardHeader, CButton, CTable, CTableHead, CTableRow, CTableHeaderCell, CTableBody, CTableDataCell, CModal, CModalHeader, CModalTitle, CModalBody, CModalFooter, CCol } from '@coreui/react'
  ...
  return (
    <CCard>
      ...
      <CCardBody>
            ...
            {collectionData.map((e, i) => {
              return (
                <CTableRow key={'tablerow' + i}>
                  ...
                  <CTableDataCell>
                    <CIcon icon={cilPencil} size="sm" style={{ '--ci-primary-color': 'blue' }} onClick={() => onEditCollection(e.id)} />
                  </CTableDataCell>
                  <CTableDataCell>
                    <CIcon icon={cilTrash} size="sm" style={{ '--ci-primary-color': 'red' }} onClick={() => onDeleteCollection(e.id)} />
                  </CTableDataCell>
                </CTableRow>
              )
            })}
        ...
        <CModal visible={showCollectionDlg} size="lg" onClose={() => onCloseCollectionDialog()}>
          ...
          <CModalFooter>
            ...
            <CButton color="primary" onClick={() => onAddCollection()}>
              Add Collection
            </CButton>
          </CModalFooter>
        </CModal>
        ...
        >
            ...
            <CForm className="row g-3">
              <CCol sm={6} md={6}>
                <CFormInput
                  ...
                  placeholder="Name"
                  label="Name"
                  value={collectionInfo.collection_name}
                  onChange={(e) => {
                    setCollectionInfo({
                      ...collectionInfo,
              ...
              <CCol sm={6} md={6} className="mb-1">
                <CFormInput
                  ...
                  placeholder="Symbol"
                  label="Symbol"
                  value={collectionInfo.collection_symbol}
                  onChange={(e) => {
                    setCollectionInfo({
                      ...collectionInfo,
              ...
              {collectionInfo.properties &&
                collectionInfo.properties.map((propertyItem, propertyIndex) => (
                  <CCol xs={12} style={{ display: 'flex' }} key={'property_' + propertyIndex}>
                    <CFormInput type="text" value={propertyItem} label="Field" defaultValue={propertyItem} readOnly={true} />
                    <CButton
                      color="danger"
          ...
          <CModalFooter>
            ...
            <CButton color="primary" onClick={() => onSaveCollection()}>
              Save Collection
            </CButton>
          </CModalFooter>
        </CModal>
